...
function Films() {
  ...
  return (
    <>
      ...
      <div className="bg-[#09090B] min-h-[50vh] w-full relative overflow-x-hidden font-sans selection:bg-amber-500/30">
        ...
        <div className="relative z-10 flex flex-col items-center pt-24 px-6">
          <h2 className="text-zinc-500 font-mono text-[10px] uppercase tracking-[0.5em] mb-6">
          ...
          <p className="mt-8 text-zinc-600 font-mono text-[10px] uppercase tracking-widest italic">
            Enter film title or genre to retrieve data records
          </p>
        </div>
      </div>
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-zinc-500 mt-1">
                            <span className="text-[11px] font-mono uppercase tracking-tighter">Genre: {film.genre || 'N/A'}</span>
                          </div>
                        </div>
                      </div>
                      <button 
                        onClick={() => navigate(`/film-details/${film.film_id}`)}
                        className="text-[10px] font-mono text-zinc-500 border border-zinc-800 px-3 py-1 rounded hover:bg-zinc-800 transition-colors"
                      >
                        VIEW_DATA
                      </button>
                    </div>
